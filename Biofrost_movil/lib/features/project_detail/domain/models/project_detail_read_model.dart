...
class ProjectDetailReadModel extends Equatable {
  ...
  factory ProjectDetailReadModel.fromJson(
    ...
    // images extraídas de todo el canvas
    final images = canvas
  ...
  @override
  List<Object?> get props => [id, avgScore, totalVotes, myEvaluation, images];
}
...
class EvaluationReadModel extends Equatable {
  ...
  /// true si esta evaluación fue creada localmente (modo offline) y todavía
  /// no ha sido confirmada por el servidor.
  /// La UI lo usa para mostrar el indicador visual 🕐 "Pendiente de envío".
  ...
  factory EvaluationReadModel.fromJson(Map<String, dynamic> json) {
    ...
    return EvaluationReadModel(
      ...
      createdAt: DateTime.tryParse(json['createdAt'] as String? ?? '') ??
          DateTime.now(),
      isOptimistic: json['_isOptimistic'] as bool? ?? false,
    );
  }
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      if (isOptimistic) '_isOptimistic': true,
    };
  }

  @override
  List<Object?> get props =>
      [id, criteria, weightedTotalScore, status, createdAt, esPublico, isOptimistic];
}
