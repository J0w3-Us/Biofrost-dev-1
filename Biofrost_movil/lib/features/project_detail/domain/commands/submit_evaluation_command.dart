...
class SubmitEvaluationCommand extends Equatable {
  ...
  /// Retroalimentación general del evaluador (opcional).
  /// Se serializa como la Sección 3 del campo `contenido` en la API legada.
  final String? generalFeedback;

  @override
  List<Object?> get props =>
      [projectId, criteria, weightedTotalScore, status, generalFeedback];
}
